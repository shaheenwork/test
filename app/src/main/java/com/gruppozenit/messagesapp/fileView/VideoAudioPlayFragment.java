...
public class VideoAudioPlayFragment extends Fragment implements Player.EventListener  {
    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    private MessageAttachment file=null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            file = getArguments().getParcelable(Consts.Companion.getFILE());
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_video_audio_player, container, false);
    }
...
*/
    ...
    private void setUp() {
        ...
        buildMediaSource(Uri.parse(file.getFilePath()));
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            LoadControl loadControl = new DefaultLoadControl(
                    ...
                    Consts.MIN_BUFFER_DURATION,
                    Consts.MAX_BUFFER_DURATION,
                    Consts.MIN_PLAYBACK_START_BUFFER,
                    Consts.MIN_PLAYBACK_RESUME_BUFFER, -1, true);
            ...
            // 2. Create the player
            player =
                    ExoPlayerFactory.newSimpleInstance(new DefaultRenderersFactory(getActivity()), trackSelector,
                            loadControl);
